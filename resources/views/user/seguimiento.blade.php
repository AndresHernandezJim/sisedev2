    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
                <center><h4><b>Seguimiento de Demanda</b></h4></center>
            </div>
            <div class="box-body">
                        ...
                        <tbody>
                          @foreach ($exp as  $key)
                              <tr data-child-value="{{$key->id_expediente}}">
                                <td class="details-control"><a class="btn btn-primary btn-small" data-toggle="popover" data-content="Visauliza el seguimiento paso a paso del expediente" placement="right" rel="popover" id="nexp" title="Ver el seguimiento del Expediente {{$key->expediente}}/{{$key->serie}}"> {{$key->expediente}}</a></td>
                                <td>{{$key->fechasis}}</td>
                                <td>{{$key->Demandado}}</td>
