							...
							<tbody>
								...
								<tr data-child-value="{{$k->id}}">
						            ...
						            <td style="text-align: center;">
										...
										@if($k->status==6)
											<li><a href="/proyectista/expedientes/redactar/{{$k->expediente}}" class="btn btn-info btn-xs "data-toggle="popover" data-content="Redactar proyecto de sentencia para el expediente {{$k->expediente}}/{{$k->serie}}" data-placement="left" rel="popover" title="Redactar Proyecto"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Redactar Proyecto</a></li>
										@elseif($k->status==7)
                                            ...
                                            <li><a href="javascript:void(0)" title="Agregar Documento" onclick="agregar();" class="btn btn-xs btn-primary" data-toggle="popover" data-content="Agregar Documento de Sentencia al expediente {{$k->expediente}}/{{$k->serie}}" data-placement="left" rel="popover"title="Agregar documento"><span class="glyphicon glyphicon-plus"></span> Documento</a></li>
										@elseif($k->status==8)
                                        	...
                                        	<li><a href="javascript:void(0)" data-toggle="popover" data-content="Agregar Documento de Sentencia al expediente {{$k->expediente}}/{{$k->serie}}" data-placement="left" rel="popover"title="Agregar documento" onclick="agregar();" class="btn btn-xs btn-primary"><span class="glyphicon glyphicon-plus"></span> Documento</a></li>
                                            <li><a href="/proyectista/expedientes/ver/{{$k->expediente}}" class="btn bg-orange-active btn-xs " data-toggle="popover" data-content="Ver los Proyectos de sentencia redactados para el expediente {{$k->expediente}}/{{$k->serie}}"  data-placement="left" rel="popover" title="Ver Proyectos"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> Ver Proyectos</a></li>
										@endif
                                        </ul>
						            </td>
