        ...
        <!-- /.control-sidebar-menu -->
	 	<h3 class="control-sidebar-heading">Tipos de Documentos Disponibles</h3>
		 		...
		 		<div class="row">
			 		<div class="col-md-12">
				 		...
				 		<div class="form-group"id="formactua">
		 					...
		 					<a href="#" class="btn btn-sm btn-success" title="Actualizar el Tipo" onclick="saved();"><i class="fa fa-check"></i></a>&nbsp;<a href="#" onclick="cancelard();" class="btn btn-sm btn-warning" title="Descartar Cambios"><i class="fa fa-trash"></i></a>
	        ...
	        <ul class="control-sidebar-menu" id="listadoc">
	        	...
	        	@else
	        	@foreach($tipoac as $k)
					<li ondblclick="modificard({{$k->id}});">
						<div class="menu-info">
							<p><a href="#" onclick="eliminard({{$k->id}});"   title="Eliminar éste tipo de Documento"><i class="fa fa-times" style="color:red;"></i></a> &nbsp;{{$k->Tipo}} </p>
						</div>
					</li>
	        	@endforeach
	        	@endif
	     ...
	     <ul class="control-sidebar-menu" id="listadoc2">
	     	...
	     	@else
		     	@foreach($tipoac2 as $k)
					<li>
						<div class="menu-info">
								<p><a href="#" onclick="restaurard({{$k->id}});" title="Restablecer éste tipo de documento"><i class="fa fa-check" style="color:green;"></i></a> &nbsp;{{$k->Tipo}} </p>
						</div>
					</li>
		     	@endforeach
	     	@endif
...
<div class="tab-pane active" id="control-sidebar-home-tab" >
        <input type="hidden" id="roldocumento" value="proyectista">
        <!-- /.control-sidebar-menu -->
	 	<h3 class="control-sidebar-heading">Tipos de Documentos Disponibles</h3>
		 	<div class="control-sidebar-menu" >
		 		<div class="row">
...
<div class="tab-pane active" id="control-sidebar-home-tab" >
        <input type="hidden" id="roldocumento" value="magistrado">
        <!-- /.control-sidebar-menu -->
	 	<h3 class="control-sidebar-heading">Tipos de Documentos Disponibles</h3>
		 	<div class="control-sidebar-menu" >
		 		<div class="row">
